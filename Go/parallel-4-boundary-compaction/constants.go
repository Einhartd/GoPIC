...
const (
	...
	CmdMoveElectronsAndBoundaries                      // Krok 3 + 5: Fuzja Leap-Frog + detekcja granic elektronów
	CmdMoveIonsAndBoundaries                           // Krok 4 + 6: Fuzja Leap-Frog + detekcja granic jonów + IFED
