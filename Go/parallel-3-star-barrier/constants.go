...
// =============================================================================
// STAŁE FIZYCZNE I PARAMETRY SYMULACJI PIC/MCC (1D3V) W ARGONIE (OPTIMIZED)
// =============================================================================
...
const (
	CmdComputeEDensity          WorkerCommand = iota // Krok 1a: Depozycja gęstości elektronów CIC
	CmdComputeIDensity                               // Krok 1b: Depozycja gęstości jonów CIC
	CmdMoveElectrons                                 // Krok 3: Leap-Frog pchnięcie elektronów
	CmdCheckBoundariesElectrons                      // Krok 5: Sprawdzenie granic elektronów
	CmdMoveIons                                      // Krok 4: Leap-Frog pchnięcie jonów
	CmdCheckBoundariesIons                           // Krok 6: Sprawdzenie granic jonów + IFED
	CmdCollisionsE                                   // Krok 7: Zderzenia elektronów MCC
	CmdCollisionsI                                   // Krok 8: Zderzenia jonów MCC
	CmdStop                                          // Zakończenie pracy workerów
)
