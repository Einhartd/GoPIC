...
echo "=== [Go Channels RECORD] Job: ${SLURM_JOB_ID} | Threads: ${GOMAXPROCS} (Allocated Cores: ${SLURM_CPUS_PER_TASK:-1}) | Workers: ${NUM_WORKERS} | Cycles: ${N_CYCLES} | Measurement: ${MEASURE_ARG:-off} | Node: ${SLURM_JOB_NODELIST} ==="
...
cd "${SRC_DIR}"
echo ">> Kompilacja: Go Channels (Null-Collision, GOAMD64=${GOAMD64}, debug symbols zachowane dla perf)..."
