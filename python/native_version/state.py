...
class SimulationState:
    def __init__(self):
        ...
        self.sigma: list[cs.cross_section]      = [[0.0] * cs.CS_RANGES for _ in range(cs.N_CS)]
        ...
        self.counter_e_xt: cs.xt_distr          = [[0.0] * cs.N_XT for _ in range(cs.N_G)]
        """XT counter for electron properties"""
        self.counter_i_xt: cs.xt_distr          = [[0.0] * cs.N_XT for _ in range(cs.N_G)]
        """XT counter for ion properties"""
        self.ioniz_rate_xt: cs.xt_distr         = [[0.0] * cs.N_XT for _ in range(cs.N_G)]
