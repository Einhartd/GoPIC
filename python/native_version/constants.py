...
USE_NULL_COLLISION: Final[bool]        = os.environ.get("USE_NULL_COLLISION", "False").lower() in ("true", "1", "yes")
"""flag to switch between standard and null-collision methods"""

#   TYPE ALIASES
type cross_section              = list[float]
"""cross section array"""
type particle_vector            = list[float]
"""array for particle properties"""
type xvector                    = list[float]
"""array for quantities defined at gird points"""
type eepf_vector                = list[float]
"""array for EEPF"""
type ifed_vector                = list[int]
"""array for IFEDs"""
type xt_distr                   = list[list[float]]
