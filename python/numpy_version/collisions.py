...
def compute_null_collision_params(sim: SimulationState):
    ...
    print(f">> GoPIC (NumPy): null-collision: nu*_e = {sim.nu_star_e:.6e}, P*_e = {sim.P_star_e:.6e}")
    print(f">> GoPIC (NumPy): null-collision: nu*_i = {sim.nu_star_i:.6e}, P*_i = {sim.P_star_i:.6e}")
