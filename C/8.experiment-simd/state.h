...
alignas(64) inline particle_vector  x_e, vx_e, vy_e, vz_e;                       // coordinates of electrons (aligned to 64B)
alignas(64) inline particle_vector  x_i, vx_i, vy_i, vz_i;                       // coordinates of ions (aligned to 64B)

alignas(64) inline xvector          efield, pot;                                 // electric field and potential (aligned to 64B)
alignas(64) inline xvector          e_density, i_density;                        // electron and ion densities (aligned to 64B)
alignas(64) inline xvector          cumul_e_density, cumul_i_density;            // cumulative densities (aligned to 64B)
...
// Odwrotność maksymalnej częstości zderzeń dla elektronów 1 / nu*_e
inline double inv_nu_star_e = 0.0;
...
// Odwrotność maksymalnej częstości zderzeń dla jonów 1 / nu*_i
inline double inv_nu_star_i = 0.0;
...
inline std::normal_distribution<> RMB(0.0, sqrt(K_BOLTZMANN * TEMPERATURE / AR_MASS));
