...
void step2_solve_poisson(double current_time){
    xvector rho;
...
void step3_move_electrons(int t_index){
...
void step7_collisions_electrons(){
    int k, energy_index;
...
void step9_collect_xt_data(int t_index){
